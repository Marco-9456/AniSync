...
public final class DaggerAniSyncApplication_HiltComponents_SingletonC {
  ...
  public static AniSyncApplication_HiltComponents.SingletonC create() {
  ...
  private static final class ActivityCImpl extends AniSyncApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(2).add(DiscoverViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(LibraryViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends AniSyncApplication_HiltComponents.ViewModelC {
    ...
    private GetTrendingAnimeUseCase getTrendingAnimeUseCase() {
      return new GetTrendingAnimeUseCase(singletonCImpl.discoverRepositoryImpl());
    }

    private GetPopularAnimeUseCase getPopularAnimeUseCase() {
    ...
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(2).put("com.anisync.android.presentation.discover.DiscoverViewModel", ((Provider) discoverViewModelProvider)).put("com.anisync.android.presentation.library.LibraryViewModel", ((Provider) libraryViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.anisync.android.presentation.discover.DiscoverViewModel 
          return (T) new DiscoverViewModel(viewModelCImpl.getTrendingAnimeUseCase(), viewModelCImpl.getPopularAnimeUseCase());

          case 1: // com.anisync.android.presentation.library.LibraryViewModel 
  ...
  private static final class SingletonCImpl extends AniSyncApplication_HiltComponents.SingletonC {
    ...
    private void initialize() {
      this.provideApolloClientProvider = DoubleCheck.provider(new SwitchingProvider<ApolloClient>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.apollographql.apollo3.ApolloClient 
          return (T) ApolloModule_ProvideApolloClientFactory.provideApolloClient();
